...
param['api_vocab_size'] = 21505  # 21505
param['var_vocab_size'] = 7142  # 7142
param['whole_vocab_size'] = 22821  # 22821
...
opt['cuda'] = True
opt['manual_seed'] = 983
opt['train_file_folder'] = '/home/x/mydisk/HuaWeiProject/AndroidData/AndroidUsefulTrainingJson'
opt['validation_file_folder'] = '/home/x/mydisk/HuaWeiProject/AndroidData/AndroidUsefulValidJson'
...
torch.manual_seed(opt['manual_seed'])            # 为CPU设置随机种子
if opt['cuda']:
